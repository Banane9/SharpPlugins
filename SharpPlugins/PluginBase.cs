...
namespace SharpPlugins
{
    ...
    public abstract class PluginBase
    {
        ...
        protected sealed class RegisterPluginAttribute : Attribute
        {
            ...
            /// with the given optional information about the plugin to mark it as to be loaded.
            /// </summary>
            ...
            public RegisterPluginAttribute(string author = "", string description = "", string name = "", string version = "")
            {
                Author = author;
